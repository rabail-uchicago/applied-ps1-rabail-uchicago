...
1.1.1
```{r}
setwd("/Users/rabailsofi/Desktop")
...
1.1.3
```{r}
download.file("https://github.com/datasci-harris/Applied-PS1-Data-Files/blob/main/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_2016_1.zip", destfile = "rabailsofi/Desktop/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_2016_1.zip")
```
...
download.file("https://github.com/datasci-harris/Applied-PS1-Data-Files/blob/main/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_2016_1.zip", destfile = "/Users/rabailsofi/Desktop/data/On_Time_Reporting_Carrier_On_Time_Performance_1987_present_2016_1 (4).zip")
```
